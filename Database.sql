...
insert  into `categories`(`name`,`active`) values ('car','YES'),('food','YES'),('Mobile','YES');
...
insert  into `products`(`P_name`,`Barcode`,`ExDate`,`Category`) values ('abcghgh',1,'2019-08-07','food'),('Samsung',2,'2019-08-07','Mobile'),('asdas',5,'2019-08-07','Mobile'),('abc',6,'2019-08-29','car');
...
insert  into `sales`(`product_name`,`quantity`,`per_unit_price`,`total_price`,`sale_id`) values ('Samsung','0.0','5000','0.0',1),('Samsung','1','5000','5000.0',2),('as','1','100','100.0',3),('abc','0.0','121.0','0.0',4);
...
insert  into `sales_returned`(`product_name`,`product_price`,`quantity`,`total_amount`,`sale_id`) values ('juice','110','2.0','220.0','13'),('bb','110.0','1.0','110.0','13'),('Samsung','5000','1.0','5000.0','1'),('Samsung','5000','0','0','2'),('as','100','0','0','3'),('abc','121.0','1.0','121.0','4');
